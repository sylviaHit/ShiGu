...
class HomePageTest2 extends Component{
    ...
    render() {
        ...
        return (
            <View style={styles.backgroundImage}>
                ...
                <TouchableOpacity
                    style={{width: sizeArrW[9], height: height, position: 'absolute',left:0, top: 60+sizeArrW[3],backgroundColor:'#e8c4ff',padding:30,borderRadius:30}}
                    onPress={() => {this.props.navigation.navigate(pages[0])}}>
                    {/*<Image></Image>*/}
                    {/*<ImageBackground source={require('../../images/ci.png')} style={styles.linearGradient} />*/}
                </TouchableOpacity>
                <TouchableOpacity style={{width: sizeArrW[9], height: height, position: 'absolute',left:sizeArrW[9], top: 60+sizeArrW[3],backgroundColor:'#8affbc'}} onPress={() => {this.props.navigation.navigate(pages[1])}}>
                        <Text>{pages[1]}</Text>
                </TouchableOpacity>
                <TouchableOpacity style={{width: sizeArrW[9], height: height, position: 'absolute',left:0, top: 60+sizeArrW[3]+height, backgroundColor:'#a7fcff'}} onPress={() => {this.props.navigation.navigate(pages[2])}}>
                        <Text>{pages[2]}</Text>
                </TouchableOpacity>
                <TouchableOpacity style={{width: sizeArrW[9], height: height, position: 'absolute',left:sizeArrW[9], top: 60+sizeArrW[3]+height,backgroundColor:'#fff7c4'}} onPress={() => {this.props.navigation.navigate(pages[3])}}>
                        <Text>{pages[3]}</Text>
                </TouchableOpacity>
                {/*<Animated.View*/}
